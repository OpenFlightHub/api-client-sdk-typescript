...
export type ApiResponse_WorkspaceMapelementsGet = ({ type: 0, latitude: number, longitude: number, elevation?: number, id: number, uuid: string, name: string, created_at: string, updated_at: string, color: string } | { type: 1, coordinates: { latitude: number, longitude: number, elevation?: number }[], id: number, uuid: string, name: string, created_at: string, updated_at: string, color: string } | { type: 2, coordinates: { latitude: number, longitude: number, elevation?: number }[][], id: number, uuid: string, name: string, created_at: string, updated_at: string, color: string })[]
...
export type ApiResponse_WorkspaceMapelementPatch = ({ type: 0, latitude: number, longitude: number, elevation?: number, id: number, uuid: string, name: string, created_at: string, updated_at: string, color: string } | { type: 1, coordinates: { latitude: number, longitude: number, elevation?: number }[], id: number, uuid: string, name: string, created_at: string, updated_at: string, color: string } | { type: 2, coordinates: { latitude: number, longitude: number, elevation?: number }[][], id: number, uuid: string, name: string, created_at: string, updated_at: string, color: string })
