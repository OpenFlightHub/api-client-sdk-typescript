...
export type ApiResponse_WorkspaceMapelementsGet = ({ id: number, uuid: string, name: string, created_at: string, updated_at: string, type: integer, color: string, latitude: number, longitude: number, elevation?: number } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: integer, color: string, coordinates: { latitude: number, longitude: number, elevation?: number }[] } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: integer, color: string, coordinates: { latitude: number, longitude: number, elevation?: number }[][] } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: integer, color: string, latitude: number, longitude: number, radius: number })[]
...
export type ApiResponse_WorkspaceMapelementsCreateCirclePost = { id: number }

export type ApiResponse_WorkspaceMapelementPatch = ({ id: number, uuid: string, name: string, created_at: string, updated_at: string, type: integer, color: string, latitude: number, longitude: number, elevation?: number } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: integer, color: string, coordinates: { latitude: number, longitude: number, elevation?: number }[] } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: integer, color: string, coordinates: { latitude: number, longitude: number, elevation?: number }[][] } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: integer, color: string, latitude: number, longitude: number, radius: number })
