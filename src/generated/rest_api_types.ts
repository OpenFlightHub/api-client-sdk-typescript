...
export type ApiResponse_WorkspaceGeoObjectsGet = (({ id: number, uuid: string, workspace_id: number, name: string, created_at: string, updated_at: string, type: 0, sub_type: 0, tasks: { id: number }[], config: { point: [number, number, number], color: string } } | { id: number, uuid: string, workspace_id: number, name: string, created_at: string, updated_at: string, type: 0, sub_type: 1, tasks: { id: number }[], config: { line: [number, number, number][], color: string } } | { id: number, uuid: string, workspace_id: number, name: string, created_at: string, updated_at: string, type: 0, sub_type: 2, tasks: { id: number }[], config: { polygon: [number, number, number][], color: string } } | { id: number, uuid: string, workspace_id: number, name: string, created_at: string, updated_at: string, type: 0, sub_type: 3, tasks: { id: number }[], config: { center: [number, number, number], radius: number, color: string } }) | { id: number, uuid: string, workspace_id: number, name: string, created_at: string, updated_at: string, type: 1, sub_type: integer, tasks: { id: number }[], config: { longitude: number, latitude: number, height?: number, heading?: number, speed?: number } } | { id: number, uuid: string, workspace_id: number, name: string, created_at: string, updated_at: string, type: 2, sub_type: integer, tasks: { id: number }[], config: { longitude: number, latitude: number, symbol: string, height?: number, heading?: number, speed?: number } })[]

export type ApiResponse_WorkspaceGeoObjectsPost = { id: number }
