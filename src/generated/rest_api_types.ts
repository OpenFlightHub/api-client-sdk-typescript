...
export type ApiResponse_WorkspaceMapelementsGet = ({ id: number, uuid: string, name: string, created_at: string, updated_at: string, type: 0, color: string, latitude: number, longitude: number, elevation?: number } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: 1, color: string, coordinates: { latitude: number, longitude: number, elevation?: number }[] } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: 2, color: string, coordinates: { latitude: number, longitude: number, elevation?: number }[][] } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: 7, color: string, latitude: number, longitude: number, radius: number })[]
...
export type ApiResponse_WorkspaceMapelementPatch = ({ id: number, uuid: string, name: string, created_at: string, updated_at: string, type: 0, color: string, latitude: number, longitude: number, elevation?: number } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: 1, color: string, coordinates: { latitude: number, longitude: number, elevation?: number }[] } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: 2, color: string, coordinates: { latitude: number, longitude: number, elevation?: number }[][] } | { id: number, uuid: string, name: string, created_at: string, updated_at: string, type: 7, color: string, latitude: number, longitude: number, radius: number })
